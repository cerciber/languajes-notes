...
DELETE TOP(cantidad_maxima) FROM nombre_tabla;						-- Eliminar un numero determinado de registros
DELETE TOP(cantidad_maxima) FROM nombre_tabla WHERE condición;		-- Eliminar un numero determinado de registros con condición
