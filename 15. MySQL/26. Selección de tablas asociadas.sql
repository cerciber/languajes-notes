...
SELECT campos_de_las_tablas FROM nombre_tabla_1 RIGHT JOIN (nombre_tabla_2, nombre_tabla_3, nombre_tabla_N) ON (condición_de_asociación);

-- Asociar tablas listando el producto cartesiano de los registros de las tablas a la derecha (Forma 2)
SELECT campos_de_las_tablas FROM nombre_tabla_1 RIGHT OUTER JOIN (nombre_tabla_2, nombre_tabla_3, nombre_tabla_N) ON (condición_de_asociación);
...
SELECT campos_de_las_tablas FROM nombre_tabla_1 NATURAL RIGHT JOIN (nombre_tabla_2, nombre_tabla_3, nombre_tabla_N);
...
SELECT campos_de_las_tablas FROM nombre_tabla_1 NATURAL RIGHT OUTER JOIN (nombre_tabla_2, nombre_tabla_3, nombre_tabla_N);
...
SELECT campos_de_las_tablas FROM nombre_tabla_1 JOIN nombre_tabla_2 ON (condición_de_asociación) WHERE (condición);
