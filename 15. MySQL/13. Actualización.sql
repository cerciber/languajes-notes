...
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N LIMIT cantidad_maxima;										-- Actualizar un numero determinado de registros
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N ORDER BY cols_ord LIMIT cantidad_maxima;					-- Actualizar un numero determinado de registros ordenados
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE condición LIMIT cantidad_maxima;						-- Actualizar un numero determinado de registros con condición
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE condición ORDER BY cols_ord LIMIT cantidad_maxima;	-- Actualizar un numero determinado de registros ordenados con condición