...
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE campo_i GLOB '*patron*';				-- Campo que contenga un patrón (Distingue entre mayusculas y minusculas)
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE campo_i GLOB 'patron*';				-- Campo que comience con un patrón (Distingue entre mayusculas y minusculas)
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE campo_i GLOB '*patron';				-- Campo que termine con un patrón (Distingue entre mayusculas y minusculas)
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE campo_i GLOB 'patron';				-- Campo que sea iguial a un patrón (Distingue entre mayusculas y minusculas)
UPDATE nombre_tabla SET campo_1 = valor_1, campo_2 = valor_2, campo_N = valor_N WHERE campo_i GLOB '*patron1?patron2*';		-- Campo que contenga un patrón omitiendo caracteres con "?" (Distingue entre mayusculas y minusculas)
