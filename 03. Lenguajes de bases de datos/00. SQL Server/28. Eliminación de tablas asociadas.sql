...
DELETE nombre_tabla_borrar FROM nombre_tabla_1 LEFT JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando los registros de la tabla a la izquierda (Forma 2)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 LEFT OUTER JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando los registros de la tabla a la derecha (Forma 1)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 RIGHT JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando los registros de la tabla a la derecha (Forma 2)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 RIGHT OUTER JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando los registros que coinciden en ambas tablas (Froma 1)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando los registros que coinciden en ambas tablas (Froma 2)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 INNER JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando el producto cartesiano de los registros en ambas tablas
DELETE nombre_tabla_borrar FROM nombre_tabla_1 CROSS JOIN nombre_tabla_2;

-- Asociar tablas listando los registros de ambas tablas (Forma 1)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 FULL JOIN nombre_tabla_2 ON (condición_de_asociación);

-- Asociar tablas listando los registros de ambas tablas (Forma 2)
DELETE nombre_tabla_borrar FROM nombre_tabla_1 FULL OUTER JOIN nombre_tabla_2 ON (condición_de_asociación);
...
DELETE nombre_tabla_borrar FROM nombre_tabla_1 
...
DELETE nombre_tabla_borrar FROM nombre_tabla_1 LEFT JOIN nombre_tabla_2 ON (condición_de_asociación) WHERE (condición);
