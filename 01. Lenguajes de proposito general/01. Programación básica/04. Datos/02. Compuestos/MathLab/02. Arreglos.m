...
arreglo(pos_o + 1: pos_f) = arreglo    	% Asignar subarreglo en la región especificada
arreglo([pos_1 pos_2 pos_N]) = arreglo  % Asignar subarreglo en las posiciones especificadas  
...
'Contexto' arreglo(pos_o + 1: pos_f) 'Contexto'     	% Obtener subarreglo en la región especificada
'Contexto' arreglo([pos_1 pos_2 pos_N]) 'Contexto'     	% Obtener subarreglo en las posiciones especificadas 
...
size(arreglo)        % Tamaño de cada dimesión
