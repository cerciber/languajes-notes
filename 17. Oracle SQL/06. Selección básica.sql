...
SET SERVEROUTPUT ON;			-- Activar impresión en consola
dbms_output.put_line(valor);	-- Mostrar valor
SET SERVEROUTPUT OFF;			-- Desactivar impresión en consola